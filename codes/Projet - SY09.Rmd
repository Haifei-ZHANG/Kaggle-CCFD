...
tsne <- Rtsne(data.tsne, dims = 2, perplexity=30, verbose=TRUE, max_iter = 500, check_duplicates = FALSE)
...
```
```{r}
barplot(Performances_test$F1score,col=c("sandybrown","steelblue","steelblue","steelblue","steelblue","steelblue","steelblue", "steelblue","steelblue","sandybrown","steelblue","steelblue","sandybrown","steelblue","steelblue","sandybrown","steelblue","steelblue","sandybrown","steelblue","steelblue","sandybrown","steelblue","steelblue"),
ylim=c(0,1),width=1,space=1,ylab="F1 score",las=1,main = "F1-score par différentes méthodes")
text(x=seq(2,48,by=2),y=-0.002, srt = 30, adj = 1.1, labels = models,xpd = TRUE)
abline(h=c(0,0.8))
```
