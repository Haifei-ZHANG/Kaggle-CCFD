...
bagging_train_sub = sample(nrow(data),floor(0.7*nrow(data)),replace = FALSE)
...
library(ipred)
#il marche pas sur grandes donnees
bagging.model <- bagging(as.factor(Class)~.,data = bagging_train_data)
bagging.pred <- predict(bagging.model, newdata=test_x)
Performances <- add_Performance("Bagging0",bagging.pred,test_y)

bagging.model1 <- bagging(as.factor(Class)~V1+V2+V3+V4+V5+V6+V7+V8+V9+V10+V11+V12+V13+V14+V15+V16+V17+V18+V19+Amount,data = bagging_train_data)
bagging.pred <- predict(bagging.model1, newdata=test_x)
Performances <- add_Performance("Bagging1",bagging.pred,test_y)

bagging.model2 <- bagging(as.factor(Class)~V1+V2+V3+V4+V5+V6+V7+V8+V9+V10+V11+V12+V14+V16+V17+V18+V19+V21+V22+V24+V25+V26+V27+V28+Amount,data = bagging_train_data)
bagging.pred <- predict(bagging.model2, newdata=test_x)
Performances <- add_Performance("Bagging2",bagging.pred,test_y)

bagging.model0 <- bagging(as.factor(Class)~.,data = train_under_data)
bagging.pred <- predict(bagging.model0, newdata=test_x)
Performances <- add_Performance("Bagging-under0",bagging.pred,test_y)

bagging.model1 <- bagging(as.factor(Class)~V1+V2+V3+V4+V5+V6+V7+V8+V9+V10+V11+V12+V13+V14+V15+V16+V17+V18+V19+Amount,data = train_under_data)
bagging.pred <- predict(bagging.model1, newdata=test_x)
Performances <- add_Performance("Bagging-under1",bagging.pred,test_y)

bagging.model2 <- bagging(as.factor(Class)~V1+V2+V3+V4+V5+V6+V7+V8+V9+V10+V11+V12+V14+V16+V17+V18+V19+V21+V22+V24+V25+V26+V27+V28+Amount,data = train_under_data)
bagging.pred <- predict(bagging.model2, newdata=test_x)
Performances <- add_Performance("Bagging-under2",bagging.pred,test_y)

bagging.model0 <- bagging(as.factor(Class)~.,data = train_over_data)
bagging.pred <- predict(bagging.model0, newdata=test_x)
Performances <- add_Performance("Bagging-over0",bagging.pred,test_y)

bagging.model1 <- bagging(as.factor(Class)~V1+V2+V3+V4+V5+V6+V7+V8+V9+V10+V11+V12+V13+V14+V15+V16+V17+V18+V19+Amount,data = train_over_data)
bagging.pred <- predict(bagging.model1, newdata=test_x)
Performances <- add_Performance("Bagging-over1",bagging.pred,test_y)

bagging.model2 <- bagging(as.factor(Class)~V1+V2+V3+V4+V5+V6+V7+V8+V9+V10+V11+V12+V14+V16+V17+V18+V19+V21+V22+V24+V25+V26+V27+V28+Amount,data = train_over_data)
bagging.pred <- predict(bagging.model2, newdata=test_x)
Performances <- add_Performance("Bagging-over2",bagging.pred,test_y)
